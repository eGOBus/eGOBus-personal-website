...
<div className="Why-Use-e-GOBus-Section min-h-screen bg-yellow-400 py-12 px-4 sm:px-6 lg:px-8">
  <div className="text-center">
    <h2 className="head text-4xl font-bold text-gray-900 sm:text-5xl">Why Choose e-GO Bus?</h2>
    <p className="head mt-6 text-lg text-gray-800">
  ...
  <div className="  mt-10 flex flex-col md:flex-row md:space-x-6">
    {/* Questions List */}
    <div className="Questions w-full md:w-1/2 mt-6 space-y-4">
      <h3 className="text-2xl font-semibold text-gray-800">
        Here’s how e-GO Bus answers your key questions:
      </h3>
      <ul className=" text-lg space-y-3 list-disc list-inside">
        <li className="Question">Is the bus delayed due to traffic or weather conditions?</li>
        <li className="Question">Has my child safely boarded the bus?</li>
        <li className="Question">Where is the bus right now?</li>
        <li className="Question">Has the bus picked up or dropped off my child?</li>
        <li className="Question">Is the bus following the regular route, or has there been a change?</li>
        <li className="Question">Are there any incidents or emergencies involving the bus?</li>
        <li className="Question">Has the bus reached the school yet?</li>
        <li className="Question">Has my child left any personal items on the bus?</li>
        <li className="Question">Can I contact the driver directly to inquire about forgotten items?</li>
      </ul>
    </div>

    {/* Image Section */}
    <div className="image w-full md:w-1/2 mt-6 flex justify-center">
      <img 
        src="e-GO Bus.png" 
  ...
  <p className="last-text mt-6 text-lg text-gray-800">
  ...
  <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
    <div className="Features p-6 bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50 shadow-lg rounded-lg transition-transform transform hover:scale-105">
  ...
  <p className="last-text mt-8 text-lg text-gray-800">
...
{/* How Did It All Start? */}
      <div className="How-Did-It-All-Start min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8">
  <div className="max-w-7xl mx-auto text-center">
    <h3 className="text-3xl font-semibold text-gray-900">How Did It All Start?</h3>
    <p className="paras mt-6 text-lg">
    ...
    <div className="mt-8">
      <img
        ...
        className="paras w-full max-w-3xl mx-auto rounded-lg shadow-lg"
      />
    </div>
  </div>
</div>
