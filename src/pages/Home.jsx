  ...
  return (
    <div   className="overflow-x-hidden">
      ...
      <div className="hero-section relative bg-white md:gap-10 lg:flex lg:h-[82vh] lg:px-24 px-6 lg:py-20 pt-28 text-gray-800 md:flex-row lg:gap-0 gap-5 z-40 py-20  ">
        ...
        <div className="left flex flex-col justify-center lg:w-1/2 w-full pt-8">
          ...
          <div className="motto text-2xl font-medium tracking-wide mt-1 relative overflow-hidden">
            <p className="gsap-text lg:text-xl text-sm text-center lg:text-left">
              e-GO Bus is an innovative app crafted for parents, students, and
              bus drivers to make school commutes safer, more efficient, and
              less stressful. e-GO Bus delivers peace of mind by ensuring every
              school bus journey is accounted for and easy to monitor.
            </p>
        ...
        {/* Right Section */}
        <div className="right md:w-1/2 w-full lg:h-auto h-56 relative flex justify-center items-center mt-8 md:mt-0">
          <Player
            src="splashScreenAnimation.json"
            loop
            autoplay
      ...
      <div className="offer-section relative sm:mt-8 h-auto bg-[#fcd32d] px-4 pt-3 pb-16 lg:px-10 lg:rounded-t-[60px] rounded-t-[50px] lg:mt-7 z-30 flex flex-col items-center justify-center">
        <h2 className="text-4xl md:text-3xl text-center font-bold mb-4 pt-4 w-full gsap-offer-title">
          What We Offer
        </h2>
        <div className="flex flex-col lg:flex-row w-full lg:w-full gap-4 justify-center items-center">
          ...
          <div className="w-full lg:w-1/2 mt-4 items-center justify-center font-serif text-center">
            ...
            {[
              ...
              <div
                key={index}
                className="offer-item mb-4 gsap-offer-item flex flex-col items-center"
              >
                <h3 className="text-xl font-semibold mb-3 flex items-center">
                  <i
                    className={`fa-solid ${feature.icon} mr-2`}
                    aria-hidden="true"
                  ></i>{" "}
                  {feature.title}
                </h3>
      ...
      {/* How It Works Section */}
      <div
        className="how-it-works-section h-auto relative min-h-[90vh] bg-gray-800 px-6 sm:px-10 lg:rounded-t-[60px] rounded-t-[50px] flex flex-col text-white z-50 -mt-12 pb-20 justify-center items-center"
        id="howItWorks"
      >
        <h2 className="text-4xl sm:text-5xl lg:text-7xl mt-6 pt-10 pb-4 font-semibold mb-6 text-center gsap-how-title">
          How It Works?
        </h2>
        <p className="text-center px-4 sm:px-6 lg:px-0 max-w-lg text-lg sm:text-xl lg:text-2xl mb-8 gsap-how-text">
          Discover how our eGO Bus system provides tailored features and tools
          for parents and school management, ensuring a safe, efficient, and
          transparent transportation experience.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 sm:justify-center items-center">
          ...
          <Link to="/workingSchool">
            <button className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-white text-base sm:text-lg lg:text-xl py-3 px-6 sm:px-8 rounded-lg hover:from-yellow-500 hover:to-yellow-700 transition-all duration-200 focus:outline-none">
              ...
              <div className="cta-section py-20 text-center">
  <h2 className="cta-title text-4xl font-bold mb-4">
    Join the eGO Bus Revolution
  </h2>
  <p className="cta-description text-lg mb-6">
    Experience the safest and most efficient school transportation system.
  </p>
  <Link to="/about">
    <button className="cta-button bg-gradient-to-r from-yellow-400 to-yellow-500 text-white text-base sm:text-lg lg:text-xl py-3 px-6 sm:px-8 rounded-lg hover:from-yellow-500 hover:to-yellow-700 transition-all duration-200 focus:outline-none">
      Learn More
    </button>
  </Link>
</div>
      ...
      {/* FAQ Section */}
      <div className="faq-section bg-slate-100 text-gray-800 py-10 sm:py-20 px-8">
        <h2 className="text-3xl sm:text-4xl font-bold text-center mb-8 sm:mb-10 gsap-faq-title">
          ...
          {[
            {
              ...
              answer:
                "eGO Bus services are expanding rapidly. Check with your school to see if it’s available.",
            },
            {
              question: "How secure is the real-time tracking?",
              answer:
                "We use advanced encryption and secure systems to ensure data privacy and accuracy.",
            },
            {
            ...
            <details
              key={index}
              className="faq-item border-b border-gray-300 py-4 group"
              open={index === 0}
            >
              <summary className="cursor-pointer text-lg sm:text-xl font-semibold text-gray-700 flex justify-between items-center group-hover:text-yellow-500">
                {faq.question}
